...
- **当前公网地址：** `https://percent-pre-flower-revised.trycloudflare.com`（重启后变化）
- **注意事项：** 电脑需保持开机至 7/23 审核结束；重启后双击 `start.bat` 恢复
